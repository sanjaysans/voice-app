...
services+=(
  "backend|VOICE_ENVIRONMENT=$ENVIRONMENT VOICE_LIVEKIT_URL=\${VOICE_LIVEKIT_URL:-ws://127.0.0.1:7880} VOICE_LIVEKIT_API_KEY=\${VOICE_LIVEKIT_API_KEY:-devkey} VOICE_LIVEKIT_API_SECRET=\${VOICE_LIVEKIT_API_SECRET:-voice-local-dev-livekit-secret-32} uv run --package voice-backend uvicorn voice_backend.app:create_app --factory --host 0.0.0.0 --port 8100 $BACKEND_RELOAD"
  "pipeline|VOICE_ENVIRONMENT=$ENVIRONMENT VOICE_LIVEKIT_URL=\${VOICE_LIVEKIT_URL:-ws://127.0.0.1:7880} VOICE_LIVEKIT_API_KEY=\${VOICE_LIVEKIT_API_KEY:-devkey} VOICE_LIVEKIT_API_SECRET=\${VOICE_LIVEKIT_API_SECRET:-voice-local-dev-livekit-secret-32} uv run --package voice-pipeline uvicorn voice_pipeline.app:create_app --factory --host 0.0.0.0 --port 8101"
  "pipeline-worker|VOICE_ENVIRONMENT=$ENVIRONMENT VOICE_LIVEKIT_STARTUP_MODE=dispatch VOICE_LIVEKIT_URL=\${VOICE_LIVEKIT_URL:-ws://127.0.0.1:7880} VOICE_LIVEKIT_API_KEY=\${VOICE_LIVEKIT_API_KEY:-devkey} VOICE_LIVEKIT_API_SECRET=\${VOICE_LIVEKIT_API_SECRET:-voice-local-dev-livekit-secret-32} uv run --package voice-pipeline voice-pipeline-worker dev"
  "pipeline-eval-caller|VOICE_ENVIRONMENT=$ENVIRONMENT VOICE_LIVEKIT_STARTUP_MODE=dispatch VOICE_LIVEKIT_AGENT_NAME=voice-eval-caller VOICE_LIVEKIT_URL=\${VOICE_LIVEKIT_URL:-ws://127.0.0.1:7880} VOICE_LIVEKIT_API_KEY=\${VOICE_LIVEKIT_API_KEY:-devkey} VOICE_LIVEKIT_API_SECRET=\${VOICE_LIVEKIT_API_SECRET:-voice-local-dev-livekit-secret-32} VOICE_BACKEND_BASE_URL=\${VOICE_BACKEND_BASE_URL:-http://127.0.0.1:8100} VOICE_INTERNAL_API_KEY=\${VOICE_INTERNAL_API_KEY:-voice-local-internal-key} uv run --package voice-pipeline voice-pipeline-eval-caller dev"
